...
def execute(args):
    ...
    if 'grid_points_uri' in args:
        ...
        _dictionary_to_point_shapefile(grid_dict, 'grid_points', grid_ds_uri)
        ...
        if land_exists:
            ...
            _dictionary_to_point_shapefile(
...
def _dictionary_to_point_shapefile(dict_data, layer_name, output_uri):
